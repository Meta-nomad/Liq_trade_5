...
class Tests(unittest.TestCase):
 def setup_broker(self,live=False):
  s=replace(Settings.from_env(),symbols=('BTC_USDT',),data_mode='live' if live else 'synthetic',cooldown_seconds=0,stale_after_seconds=1000,high_leverage_lab=True,reversal_interval_seconds=15)
