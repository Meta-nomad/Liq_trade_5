...
class CompositeFlowStrategy:
    ...
    def _reversal_candidate(
        ...
        diagnostic = self.last_diagnostics.setdefault(state.symbol, {})
        # Restore the v0.3 reversal regime gate; trend entries remain separate.
        ...
        # Absence of observed liquidations is not evidence of exhaustion.
        if item.liquidation_events_300s == 0:
            diagnostic["reversal_blocker"] = "no_observed_liquidations"
            return None
    ...
    def evaluate_all(
        ...
        # Let the broker skip occupied/cooling-down symbols before filling slots.
        return signals
...
class StrategyRouter:
    ...
    def evaluate_all(
        ...
        current_time = now or time.time()
        self.composite.last_diagnostics.clear()
